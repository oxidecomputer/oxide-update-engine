...
use crate::line_display_shared::{
    LineDisplayFormatter, LineDisplayOutput, LineDisplayShared,
};
...
impl LineDisplayStyles {
    ...
    pub fn colorized() -> Self {
        Self {
            ...
            meta_style: Style::new().bold(),
            step_name_style: Style::new().cyan(),
            progress_style: Style::new().bold().green(),
            progress_message_style: Style::new().green(),
            warning_style: Style::new().bold().yellow(),
            warning_message_style: Style::new().yellow(),
            error_style: Style::new().bold().red(),
            error_message_style: Style::new().red(),
            skipped_style: Style::new().bold().yellow(),
            retry_style: Style::new().bold().yellow(),
        }
    }
}
