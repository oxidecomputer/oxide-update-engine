...
use crate::{line_display::LineDisplayStyles, utils::ProgressRatioDisplay};
...
pub(crate) const HEADER_WIDTH: usize = 9;

#[derive(Debug, Default)]
pub(crate) struct LineDisplayShared {
...
#[derive(Debug)]
pub(crate) struct LineDisplaySharedContext<'a> {
...
impl LineDisplaySharedContext<'_> {
    ...
    /// responsibility.
    pub(crate) fn format_generic(&self, message: &str) -> String {
    ...
    /// This line does not have a trailing newline; adding one is the caller's
    /// responsibility.
    pub(crate) fn format_terminal_info(
        &self,
...
#[derive(Debug)]
pub(crate) struct LineDisplayFormatter {
...
impl LineDisplayFormatter {
    ...
    #[inline]
    pub(crate) fn styles(&self) -> &LineDisplayStyles {
        &self.styles
    }

    #[inline]
    pub(crate) fn set_styles(&mut self, styles: LineDisplayStyles) {
        self.styles = styles;
    }

    #[inline]
    pub(crate) fn set_progress_interval(&mut self, interval: Duration) {
...
#[derive(Clone, Debug)]
pub(crate) struct LineDisplayOutput {
    lines: Vec<String>,
}
